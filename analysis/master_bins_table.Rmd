...
table_name <- "Kumar_2020_master_bins_10kb_table"

if (params$shrink) {
  table_name <- paste(table_name, "_shrunk", ".tsv", sep = "")
} else {
  table_name <- paste(table_name, "_raw", ".tsv", sep = "")
}
...
master_df <- cbind(master_df, df_diff[, c(5:length(colnames(df_diff)))])
