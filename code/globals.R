...
bwfiles_rep <-
  list(
    ...
    k27_naive_ezh2i = list.files(bwdir, pattern = "H3K27m3_H9_Ni-EZH2i_rep[1-3].hg38.scaled.bw", full.names = T),
    k27_primed = list.files(bwdir, pattern = "H3K27m3_H9_Pr_rep[1-3].hg38.scaled.bw", full.names = T),
    k27_primed_ezh2i = list.files(bwdir, pattern = "H3K27m3_H9_Pr-EZH2i_rep[1-3].hg38.scaled.bw", full.names = T),
    ...
    in_naive = list.files(bwdir, pattern = "IN_H9_Ni_.*rep[1-3].hg38.*.bw", full.names = T),
