...
params:
  ...
  fc_cutoff: 1
  bin_size: 10000
  rnaseqdir: ./data/rnaseq/Collier_2017
  length_cutoff: 500
  value_cutoff: 0.01
  deciding_stat: "TPM"
---
...
* **Gene expression groups**: Data from [@collier2017] was used to select top-med-low groups of genes by expression. Genes
were pre-filtered by transcript length (> `r params$length_cutoff`) and minimum `r params$deciding_stat` (`r params$value_cutoff`) and top, med and low 10% of genes were retained per replicate. Genes were annotated to each of these categories if they appeared in all three replicates within the given range. Downloads: Naïve [top](../data/bed/Collier_2017/Collier_2017_Naive_top.bed), [med](../data/bed/Collier_2017/Collier_2017_Naive_med.bed) and [low](../data/bed/Collier_2017/Collier_2017_Naive_low.bed). Primed [top](../data/bed/Collier_2017/Collier_2017_Primed_top.bed), [med](../data/bed/Collier_2017/Collier_2017_Primed_med.bed) and [low](../data/bed/Collier_2017/Collier_2017_Primed_low.bed).
* **Differentially expressed genes**: Data from [@collier2017] was analysed with DESeq2 to obtain Naïve vs. Primed differentially expressed genes. Genes were selected if adjusted p value from DESeq2 was lower than `r params$pval_cutoff` and absolute value of log2 fold change was > `r params$fc_cutoff`. Downloads: [Naïve_up](../data/bed/Collier_2017/Collier_2017_Naive_down_05_logfc1.bed), [Naïve_down](../data/bed/Collier_2017/Collier_2017_Naive_up_05_logfc1.bed).
